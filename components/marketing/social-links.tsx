  ...
  return (
    <div className={`flex items-center justify-center gap-4 ${className}`}>
      <a
        ...
        className={`text-ocean-600 transition hover:text-ocean-900 ${iconClassName}`}
        aria-label="Instagram — Viagens com Sílvia"
      >
      ...
      <a
        ...
        rel="noopener noreferrer"
        className={`text-ocean-600 transition hover:text-ocean-900 ${iconClassName}`}
        aria-label="TikTok — Silvia Milheiro"
      >
        <TikTokIcon className="h-6 w-6" aria-hidden />
      </a>
    </div>
  );
}
